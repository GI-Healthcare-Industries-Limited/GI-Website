  ...
  return <main className={styles.page}>
    ...
    <article>
      ...
      <section id="recruitment-answers"><h2>Your application answers</h2>
        <p>Recruitment addendum version {APPLICATION_PRIVACY_NOTICE_VERSION}, effective 15 September 2026. We record the short answers and award cards you submit, together with the time and version of your application data-use agreement. We do not record your typing, clipboard, or browsing activity. A human reviews applications; there is no automated personality assessment.</p>

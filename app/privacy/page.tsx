  ...
  return <main className={styles.page}>
    ...
    <article>
      ...
      <section><h2>Your choices and the eligibility questions</h2>
        <p>Phone numbers are optional. Other requested application fields are needed to consider an online application; name, email and message are needed to respond to an enquiry. You can contact us for help or an accessible alternative. Submitting is not marketing consent and does not enrol you in a future-jobs talent pool.</p>

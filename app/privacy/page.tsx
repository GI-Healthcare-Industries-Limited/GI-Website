  ...
  return <><SiteHeader activePath="/privacy" contentId="privacy-main" /><main id="privacy-main" tabIndex={-1} className={styles.page}>
    <article>
      ...
      <section><h2>What we collect and why</h2>
        ...
        <p>We also ask whether you are a current student or a graduate. Current students provide their degree and year of study; graduates provide their graduation year. These required application details help the owner understand your education. They are not used for an automatic age or education-based rejection and are deleted with the rest of your application.</p>

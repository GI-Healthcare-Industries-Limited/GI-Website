  ...
  return <><SiteHeader activePath="/privacy" contentId="privacy-main" /><main id="privacy-main" tabIndex={-1} className={styles.page}>
    <article>
      ...
      <section id="recruitment-answers"><h2>Your application answers</h2>
        <p>Recruitment addendum version {APPLICATION_PRIVACY_NOTICE_VERSION}, effective 15 September 2026. We record your LinkedIn profile link, short answers and award cards, together with the time and version of your application data-use agreement. The owner may open your LinkedIn link to review your professional background; the portal does not automatically fetch, embed or copy your profile. Earlier applications may retain a phone number until their original deletion date. We do not record your typing, clipboard, or browsing activity. A human reviews applications; there is no automated personality assessment.</p>

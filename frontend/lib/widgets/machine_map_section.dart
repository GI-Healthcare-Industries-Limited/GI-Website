                ...
                return !isMobile
                    ? Stack(
                        children: [
                          ...
                          // The open sky at the upper left has no map markers. Keep
                          // the copy here, before hotspots so expanded cards stay above it.
                          Positioned(
                            top: 0,
                            left: 0,
                            width: mapWidth * 0.31,
                            height: mapHeight * 0.49,
...
class _MissionStatement extends StatelessWidget {
  const _MissionStatement({required this.fontSize, required this.color});
  ...
  Widget build(BuildContext context) {
    return Semantics(
      header: true,
      child: Text(
        'Our mission is to make freshly cooked, healthy meals easily accessible '
        'to anyone, anytime, anywhere — even beyond planet Earth.',
        style: TextStyle(
          fontFamily: 'Inter',
          fontSize: fontSize,
          height: 1.4,
